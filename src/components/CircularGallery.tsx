...
// ---- Composition with ElectricBorder ----

type GalleryWithBorderProps = CircularGalleryProps & {
  // ElectricBorder controls
...
const CircularGalleryWithElectricBorder: React.FC<GalleryWithBorderProps> = ({
  // CircularGallery
  items,
  bend,
  textColor,
  ...
  return (
    ...
    >
      {/* Make sure the child fills the framed area so OGL can size correctly */}
...
export default CircularGalleryWithElectricBorder;
